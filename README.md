...
- **For more details, here are my blog posts explaining in depth what's going on under the hood for each implementation ([naive][naive-blog] and [fast][fast-blog]).**
