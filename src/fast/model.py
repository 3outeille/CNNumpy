...
class ToyModel:
    ...
    def __init__(self):
        self.conv1 = Conv(nb_filters=8, filter_size=5, nb_channels=1)
        self.tanh1 = TanH()
        self.conv2 = Conv(nb_filters=8, filter_size=5, nb_channels=8)
        self.tanh2 = TanH()
        self.pool1 = AvgPool(filter_size=2, stride=2)
        self.fc1 = Fc(row=10,column=12*12*8)
    ...
    def forward(self, X):
        ...
        self.pool1_shape = out.shape
        out = out.reshape(self.pool1_shape[0], -1)
    ...
    def backward(self, y_pred, y):
        ...
        deltaL = self.pool1.backward(deltaL) #(16x10x10)
